...
class WidgetUpcomingPaymentsProvider : AppWidgetProvider() {
    override fun onUpdate(context: Context, appWidgetManager: AppWidgetManager, appWidgetIds: IntArray) {
        ...
        for (appWidgetId in appWidgetIds) {
            ...
            views.setTextViewText(R.id.widget_upcoming_payment1, WidgetTheme.maskIf(balanceHidden, payment1))
            views.setTextViewText(R.id.widget_upcoming_payment2, WidgetTheme.maskIf(balanceHidden, payment2))
