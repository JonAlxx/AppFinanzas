...
class WidgetCalendarProvider : AppWidgetProvider() {
    override fun onUpdate(context: Context, appWidgetManager: AppWidgetManager, appWidgetIds: IntArray) {
        ...
        for (appWidgetId in appWidgetIds) {
            ...
            if (!isDark) {
                views.setInt(R.id.widget_calendar_container, "setBackgroundColor", android.graphics.Color.parseColor("#FFFFFF"))
                ...
                views.setInt(R.id.widget_calendar_container, "setBackgroundColor", android.graphics.Color.parseColor("#0B1120"))
