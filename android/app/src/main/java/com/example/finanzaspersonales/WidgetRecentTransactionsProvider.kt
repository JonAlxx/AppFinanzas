...
class WidgetRecentTransactionsProvider : AppWidgetProvider() {
    override fun onUpdate(context: Context, appWidgetManager: AppWidgetManager, appWidgetIds: IntArray) {
        ...
        for (appWidgetId in appWidgetIds) {
            ...
            views.setTextViewText(R.id.widget_recent_tx1_val, WidgetTheme.maskIf(balanceHidden, val1))
            views.setTextViewText(R.id.widget_recent_tx1_meta, meta1)
            views.setTextViewText(R.id.widget_recent_tx2_name, name2)
            views.setTextViewText(R.id.widget_recent_tx2_val, WidgetTheme.maskIf(balanceHidden, val2))
