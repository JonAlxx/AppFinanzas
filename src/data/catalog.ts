...
export const BRANDS: Record<string, Brand> = {
  ...
  banamex:     { logo: require('../../assets/brands/banamex.png'),     bg: '#0B3A75', text: '#FFFFFF', short: 'Banamex', name: 'Banamex' },
  santander:   { logo: require('../../assets/brands/santander.png'),   bg: '#EC0000', text: '#FFFFFF', short: 'Santander', name: 'Santander' },
  hsbc:        { logo: require('../../assets/brands/hsbc.png'),        bg: '#DB0011', text: '#FFFFFF', short: 'HSBC', name: 'HSBC' },
  banorte:     { logo: require('../../assets/brands/banorte.png'),     bg: '#D71920', text: '#FFFFFF', short: 'Banorte', name: 'Banorte' },
  scotiabank:  { logo: require('../../assets/brands/scotiabank.png'),  bg: '#E31837', text: '#FFFFFF', short: 'Scotia', name: 'Scotiabank' },
  inbursa:     { logo: require('../../assets/brands/inbursa.png'),     bg: '#003A70', text: '#FFFFFF', short: 'Inbursa', name: 'Inbursa' },
  ...
  multiva:     { bg: '#253746', text: '#FFFFFF', short: 'Banco Multiva', name: 'Banco Multiva' },
  invex:       { bg: '#002D72', text: '#FFFFFF', short: 'Invex', name: 'Invex' },
  americanexpress: { logo: require('../../assets/brands/americanexpress.png'), bg: '#006FCF', text: '#FFFFFF', short: 'Amex', name: 'American Express' },
  ...
  paypal:      { logo: require('../../assets/brands/paypal.png'),      bg: '#003087', text: '#FFFFFF', short: 'PayPal', name: 'PayPal' },
